    ...
    return (
        <Container maxWidth='sm' sx={signinStyles.containerStyle}>
            ...
            <form onSubmit = {handleSubmit(onSubmit)}>
                ...
                <Input {...register('email')} name='email' placeholder='email here ... or else'/>
                </div>

                <div>
                <label htmlFor='password'>Password</label>
                <Input2 {...register('password')} name='password' placeholder='password here ... or else'/>
                </div>

                <Button type='submit'> Submit </Button>
            </form>

            <NavA to="/signup"> Want to Join? Register Now!</NavA>

            <GoogleButton open={open} onClick={handleSnackClose} />
            <Snackbar message='Success' open={open} autoHideDuration={3000}>
                <Alert severity='success'> 
                    <AlertTitle>Successful - Redirect in 3 seconds</AlertTitle>   
                </Alert>
            </Snackbar>
        </Container>
    )
...
export const SignUp = (props: userProps) => {
    ...
    return (
        <Container maxWidth='sm' sx={signinStyles.containerStyle}>
            ...
            <Snackbar message='Success' open={open} autoHideDuration={3000}>
                <Alert severity='success'>
                    <AlertTitle>Succesful - Redirect in 3 seconds</AlertTitle>
                </Alert>
            </Snackbar>
        </Container>
    )
